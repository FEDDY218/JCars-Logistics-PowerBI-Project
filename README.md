...
Power BI Sales Dashboard using PostgreSQL (Aiven) Project Objective
...
Power BI Desktop was connected directly to the Aiven PostgreSQL database by: Selecting Get Data → PostgreSQL Database.
...
Measures and Calculations The dashboard includes several calculated measures, including: .Total Revenue
